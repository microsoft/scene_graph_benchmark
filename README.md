...
- Build Docker image: `docker build -t au/sgb:10.1-cudnn7-devel-ubuntu18.04 .`
- Run it: `docker run -it -v $PWD:/kern_nemesis --gpus all au/sgb:10.1-cudnn7-devel-ubuntu18.04`
